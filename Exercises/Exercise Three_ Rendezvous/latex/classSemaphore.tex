...
A \mbox{\hyperlink{classSemaphore}{Semaphore}} Implementation Uses C++11 features such as mutex and condition variables to implement \mbox{\hyperlink{classSemaphore}{Semaphore}}.
